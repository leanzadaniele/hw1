...
function setLike(event){
    ...
    const url = "setLike.php?post_id="+post_id+"&user_id="+user_id;
    console.log(url);
...
function fetchComments(){
    ...
    for(let id of postIdsData){
        ...
        const url = "getComments.php?post_id=" + id.dataset.postId;
        console.log(url);
...
function getLikes(){
    ...
    for(let id of postIdsData){
        //console.log(id.dataset.postId);
        const url = "getLikes.php?post_id=" + id.dataset.postId;
        //console.log(url);
...
function setLiked(){
    fetch("isLiked.php").then(onResponseSetLiked).then(onJsonSetLiked);
}
...
fetch("postFetch.php").then(onResponse).then(onJson);
